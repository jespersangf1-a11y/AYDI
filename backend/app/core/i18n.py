...
_register("error.csrf_invalid", "Sicherheitsvalidierung fehlgeschlagen. Bitte Seite neu laden und erneut versuchen.", "Security validation failed. Please reload the page and retry.", "Validacion de seguridad fallida. Por favor recargue la pagina.", "Validation de securite echouee. Veuillez recharger la page.")
