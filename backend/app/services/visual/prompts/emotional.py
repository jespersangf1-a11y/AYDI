...
def get_emotional_impact_prompt(
    ...
    return f"""Du bist ein erfahrener Yachtdesigner und Innenarchitekt mit besonderem Gespuer fuer emotionale Raumwirkung. Du verstehst, warum manche Raeume als premium, einladend oder beklemmend empfunden werden. Analysiere dieses Bild.
