...
BOAT_CLASS_DEFAULTS = {
    ...
    "racing_sail": {
        "benchmark_cost_per_meter": 28000,
        "labor_rate_eur_hour": 58,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.42,
            "labor": 0.33,
        ...
        "parametric_model": {
            "base_cost_per_m": 28000,
            "hull_pct": 0.28,
            "deck_rigging_pct": 0.17,
            "interior_pct": 0.30,
            "systems_pct": 0.15,
            "design_pct": 0.10,
        },
    ...
    "daysailer": {
        "benchmark_cost_per_meter": 18000,
        "labor_rate_eur_hour": 54,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.40,
            "labor": 0.35,
        ...
        "parametric_model": {
            "base_cost_per_m": 16000,
            "hull_pct": 0.24,
            "deck_rigging_pct": 0.14,
            "interior_pct": 0.36,
            "systems_pct": 0.14,
            "design_pct": 0.12,
        },
    ...
    "motorsailer": {
        "benchmark_cost_per_meter": 40000,
        "labor_rate_eur_hour": 61,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.37,
            "labor": 0.33,
        ...
        "parametric_model": {
            "base_cost_per_m": 40000,
            "hull_pct": 0.20,
            "deck_rigging_pct": 0.12,
            "interior_pct": 0.39,
            "systems_pct": 0.19,
            "design_pct": 0.10,
        },
    ...
    "catamaran_sail": {
        "benchmark_cost_per_meter": 36000,
        "labor_rate_eur_hour": 59,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.38,
            "labor": 0.34,
    ...
    "catamaran_motor": {
        "benchmark_cost_per_meter": 55000,
        "labor_rate_eur_hour": 63,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.35,
            "labor": 0.32,
    ...
    "small_motor": {
        "benchmark_cost_per_meter": 45000,
        "labor_rate_eur_hour": 61,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.36,
    ...
    "sport_cruiser": {
        "benchmark_cost_per_meter": 75000,
        "labor_rate_eur_hour": 66,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.33,
            "labor": 0.31,
    ...
    "trawler": {
        "benchmark_cost_per_meter": 80000,
        "labor_rate_eur_hour": 67,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.32,
            "labor": 0.31,
        ...
        "parametric_model": {
            "base_cost_per_m": 80000,
            "hull_pct": 0.17,
            "deck_rigging_pct": 0.09,
            "interior_pct": 0.40,
            "systems_pct": 0.24,
            "design_pct": 0.10,
        },
    ...
    "explorer": {
        "benchmark_cost_per_meter": 95000,
        "labor_rate_eur_hour": 70,
        "boat_length_m": 0,
        "ideal_distribution": {
            "material": 0.31,
            "labor": 0.31,
