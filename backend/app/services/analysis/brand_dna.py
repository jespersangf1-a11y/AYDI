...
BOAT_CLASS_DEFAULTS: dict[str, dict] = {
    ...
    "racing_sail": {
        "min_reference_models": 3,
        "proportion_deviation_threshold": 2.2,
        "weights": {
            "topology": 0.30,
            "proportions": 0.20,
            "materials": 0.15,
    ...
    "motorsailer": {
        "min_reference_models": 3,
        "proportion_deviation_threshold": 1.9,
        "weights": {
            "topology": 0.22,
            "proportions": 0.24,
            "materials": 0.20,
    ...
    "catamaran_sail": {
        "min_reference_models": 3,
        "proportion_deviation_threshold": 2.1,
        "weights": {
            "topology": 0.28,
            "proportions": 0.22,
            "materials": 0.18,
    ...
    "sport_cruiser": {
        "min_reference_models": 3,
        "proportion_deviation_threshold": 1.7,
        "weights": {
            "topology": 0.19,
            "proportions": 0.19,
            "materials": 0.20,
    ...
    "explorer": {
        "min_reference_models": 3,
        "proportion_deviation_threshold": 1.6,
        "weights": {
            "topology": 0.17,
            "proportions": 0.19,
            "materials": 0.21,
