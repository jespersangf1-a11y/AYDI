...
4. Batterie-Spannungsverlauf überwachen (nicht unter 21V bei 24V-System fallen)
...
**Schwimmer-Schalter:** Mechanisches Bauteil mit Auftrieb um Wasserspiegel zu erkennen. Auslöser für Bilgepumpe.

**Seewasser-Kreislauf:** Salzwassersystem um Motor zu kühlen. Separates System, muss korrosionsbeständig sein.

**Seihtuch-Filter:** Grobe Filterung (50–100 µm) im Wasser-Ansaug zur Vorsortierung vor Feinteilung.

**Selbstansaugende Pumpe:** Design das Luft aus Saugleitung ausstößt bevor Wasser fließt. Ideal für über Tank montierte Pumpen.

**Sensor:** Elektronisches oder mechanisches Erfassungs-Element (Druck, Durchfluss, Temperatur).

**Servoventil:** Druckabstufungs-Ventil mit Proportional-Betätigung. Selten in Standard-Marine-Anwendungen.

**Set-Point:** Sollwert bei dem Regelgerät anspricht (z.B. 2.0 bar für Druckschalter).

**Shellac-Dichtung:** Wachs-basierte Dichtungsmasse um Rohre wasserdicht zu machen. Veraltet, heute PTFE-Tape standard.

**Sinter-Bronzekörper:** Gesinterte Metallkonstruktion für hochwertige Ventile (korrosionsbeständig, haltbar).

**Sinterfilter:** Hochwertige Filterung mit Sinterstruktur (10–50 µm). Langlebig, waschbar.

**Siphon-Brecher:** Ventil um zu verhindern dass Siphon-Effekt Wasser zurück in Tank saugt.

**Sitzen-Faktor:** Maß für Abdicht-Qualität bei Ventilen. Ideal: <10^-6 ml/min Leckagestrom unter Maximaldruck.

**Spannung-Abfall:** Stromverlust in Stromkreis (Widerstand × Amperage = Volt). Sollte <0.5V sein in 24V-Systemen.

**Speicher-Tank (accumulator):** Druck-Speicher-Behälter mit Membran. Schätzwert 10 L Standard.

**Sperrdruck:** Maximaler Druck um Ventil geschlossen zu halten.

**Sperre-Diagramm:** Zeichnung zur Visualisierung von Schalt-Logik und Abhängigkeiten.

**Spülschlauch:** Einsatz-Schlauch um Rohre bei Installation/Wartung durchzuspülen.

**Stahl-Rohre (Stahlrohre):** Korrosionsanfällig im Salzwasser, daher selten. Nur für Süßwasser oder mit Beschichtung.

**Standard-Schaltpunkt:** Typischer Betriebspunkt (z.B. 2.0 bar für Fahrtenyacht).

**Staudruck:** Statischer Druck ohne Durchfluss (Still-Messung).

**Stauchrohr (pitot tube):** Instrument um Durchfluss-Geschwindigkeit zu messen.

**Steuerventil:** Ventil mit Proportional-Betätigung zur Durchfluss-Kontrolle.

**Stöpselventil:** Einfaches Absperr-Ventil (ein/aus).

**Stromaufnahme (Amperage):** Elektrische Leistung in Ampere. Wichtig um Sicherung/Breaker Größe zu bestimmen.

**Stummschaltung:** Funktion um Alarm-Signale zu unterdrücken bei bekanntem Fehler.

**Sumpf-Geometrie:** 3D-Form von Bilge-Sammelbecken. Wichtig für Pumpen-Saug-Sicherheit.

**Sumpfpumpe:** Kleine Pumpe mit integriertem Schwimmer für enge Räume (Dusch-Sumpf, Bilge-Seitentaschen).

**System-Integration:** Zusammenschluss aller Komponenten in ein funktionierendes Ganzes.

**Tal-Ventil:** Höhen-Ausgleichs-Ventil um Druckausgleich während Fahrt zu ermöglichen.

**Tanks-Gewicht-Verteilung:** Auswirkung von vollen Wassertanks auf Boot-Trimmung und Stabilität.

**Tauchrohr:** Ansaug-Rohr das bis zur Tank-Unterseite reicht (verhindert Ansaugen von oberflächlichem Schlamm).

**Temperatur-Koeffizient:** Änderung der Pumpenparam. pro °C. Z.B. Viskosität sinkt ~3% pro °C.

**Temperatur-Regler:** Elektronische Steuerung um Betriebstemperatur zu halten.

**Temperaturschalter:** Schalter der bei Übertemperatur Pumpe abschaltet (z.B. >50°C).

**Test-Protokoll:** Dokumentation aller Messwerte bei Funktionsprobe.

**Textur-Rauheit:** Oberflächenrauheit von Rohren (wichtig für Strömungs-Widerstand).

**Thermometer:** Temperatur-Messinstrument.

**Thermostatic-Bypass-Ventil:** Temperatur-Regler der Durchfluss mit Wärme abgleicht.

**Thermostat:** Automatische Temperatur-Regulierung.

**Tischtest:** Laborprüfung vor Schiffs-Installation um Fehler auszuschließen.

**Titanzahnrad:** Ultra-hochwertige Zahnrad-Material (teuer, selten).

**Topf-Magnet:** Magnet in Behälter um Metallspäne aus Ölsumpf zu sammeln.

**Torque (Drehmoment):** Rotations-Kraft in Newton-Meter. Wichtig für Schrauben-Anzugs-Druck.

**Totalverlust-Schmierung:** Pumpen-Design wo Schmieröl nicht rezirkuliert sondern vollständig abläuft.

**Trägheits-Effekt:** Verzögerung bei Druckänderungen wegen Schlauch-Volumen und Flüssigkeits-Masse.

**Traversal-Effekt:** Querkraft bei Ansaugung wenn Ansaugleitung zu dünn ist.

**Trichter-Einsatz (strainer basket):** Grobe Filterung im Tankansaug zum Schutz vor größeren Fremdkörpern.

**Trinkwasser-Standard:** ISO 3696 für Schiffswasser: pH 6.5–8.5, Leitfähigkeit <2500 µS/cm, Salzgehalt <30ppt.

> ⚠️ **ZU PRÜFEN (Audit):** ISO 3696 ist "Water for analytical laboratory use" (ultrareines Laborwasser für die chemische Analyse) — KEIN Trinkwasser-/Schiffswasser-Standard (verifiziert: iso.org/standard/9169.html). Für Trinkwasser an Bord ist ISO 15748 (Trinkwasserversorgung auf Schiffen) einschlägig; die Grenzwerte pH 6,5–8,5 und Leitfähigkeit ≤2500 µS/cm entsprechen der EU-Trinkwasserrichtlinie, nicht ISO 3696. Der angegebene "Salzgehalt <30 ppt" ist zudem unplausibel (nahe Meerwasser ≈35 ppt) — Trinkwasser liegt weit darunter. Normnummer und Salzgehalt-Wert unverifiziert.

**Trockenlauf-Schutz:** Automatisches Abschalten wenn Pumpe ohne Wasser läuft.

**Tupfblock (cartridge):** Austausch-Kartusche für Filterpatronen in Gehäuse.

**Turbolader-Effekt:** Erhöhte Druckerzeugung durch Zentrifugal-Wirkung bei hohen Drehzahlen.

**Überdruckventil (relief valve):** Sicherheitsventil das bei Maximaldruck öffnet um Beschädigungen zu verhindern.

**Übergangsmetall (transition metal):** Zinn/Kupfer-Übergang um galvanische Korrosion zu verhindern.

**Überlast:** Betrieb über Nennlast hinaus. Führt zu Überhitzung und Verschleiß.

**Überprüfung (verification):** Systematische Kontrolle gegen Spezifikation.

**Überstrom-Auslöser:** Sicherung die bei zu viel Amperage trennt.

**Übertragung (transmission):** Mechanical Link zwischen Motor und Pumpen-Element (Kupplung, Zahnrad).

**Überwachungs-Sensor:** Permanente Erfassung um Fehler/Abweichung zu erkennen.

**Umgebungs-Temperatur:** Raumtemperatur wo Pumpe betrieben wird.

**Umkehrbetrieb:** Möglichkeit Pumpenrichtung zu wechseln (selten, nur Spezial-Pumpen).

**Umlauf-Kühlsystem:** Zirkulation von Kühlflüssigkeit durch Motor um Wärmestau zu vermeiden.

**Unabhängige Stromversorgung:** Separate Batterie/Schalter um Ausfallsicherheit zu erhöhen.

**Unebenheit-Toleranz:** Maß für Fertigungs-Genauigkeit (z.B. ±0.05mm bei Ventilsitze).
...
- [ ] Wassertank-Füllstand prüfen (sollte min. 50% sein)
- [ ] Bilge sichtprüfen (sollte trocken sein, max. 10 l Wasser)
- [ ] Druck-Manometer-Startwert notieren (z.B. 0.0 bar bei 24V-Pumpe = normal)
- [ ] Druckschalter manuell betätigen (sollte Klick hörbar sein)
- [ ] Toiletten-Spültest durchführen (Wasser sollte sofort kommen)
- [ ] Bilgepumpe Test: Schwimmer manuell auslösen (Pumpe sollte starten)
- [ ] Alle Schläuche visuell inspizieren (keine Risse, Abknickungen)
- [ ] Batterien-Spannung prüfen (24V = 24–27V, 12V = 12–14V)

### Notfall-Szenarien auf See

| Szenario | Sofortmaßnahmen | Backup-Option |
|----------|---|---|
| Druckwasser aus | Manualpumpe nutzen oder Eimer | Süßwasser-Tank im Bad spülen mit Meerwasser aus Eimer |
| Toilette blockiert | Macerator stoppen, Kolben-Pumpe versuchen | Eimer-System (Komposttoilette) |
| Bilge läuft | Notbilge-Pumpe starten, Leck suchen | Handbilge-Pumpe |
| Alle Pumpen aus | Batterie prüfen, Sicherungen kontrollieren | Manuellzug-Lasten reduzieren, Notanker treiben |

### Ersatzteil-Kit (empfohlen)

- 2× Impeller (Flojet + Shurflo)
- 3× Druckschalter (2.0 bar, 24V)
- 4× Rückschlag-Ventile (unterschiedliche Größen)
- 10m Schlauch (SAE 100R2, 6.4mm ID)
- 20× Schlauch-Schellen (Edelstahl 316)
- 5× PTFE-Tape (pro Rolle)
- 2× Akkumulator-Membran-Kit
- 1× Komplettes Macerator-Dichtungs-Set
- Werkzeuge: Drehmoment-Schlüssel (0–25 Nm), Druckluft-Pumpe, Stahlspirale (Rohrreiniger)

### Zielwerte für Betrieb

| Parameter | Min. | Sollwert | Max. |
|-----------|------|----------|------|
| Druckwasser (bar) | 1.5 | 2.0 | 2.5 |
| Bilge (Wasser-Tiefe) | 0 cm | 0 cm | 5 cm (Alarm) |
| Tank-Füllstand | 10% | 50% | 100% |
| Betriebstemperatur (°C) | 5 | 25 | 45 |
| Akkumulator Vordruck (bar) | 0.5 | 0.7 | 0.9 |
| Stromaufnahme (A) | 0 | 3–5 | 10 (Überload) |

### Kontakt-Ressourcen

- Flojet Technischer Support: +46 651 15 000 (Schweden, EU)
- Shurflo Global: +1 626 357 2842 (USA)
- HMS Macerator (Nordsee): +49 4154 7090 (Deutschland)
- Stieglitz Pumpen (Osteuropa): +45 4450 2200 (Dänemark)
- AYDI Technik-Hotline (Boat Class Kalibrierung): support@aydi.com

---

## ANHANG A: Fallstudie — Druckwasserpumpe Upgrade (Kleinboot → Fahrtenyacht)

**Boot:** Bavarian 36 (12m, 4 Kabinen, Charterflotte)

**Problem:** Alte Shurflo 3-Liter-Pumpe schafft nicht mehr die Versorgung von 4 Duschen + 2 Hähne gleichzeitig. Druck bei Volllast sinkt auf <1.0 bar.

**Diagnose:**
- Impeller sichtbar abgeflacht (5 Jahre Betrieb)
- Druckschalter-Sollwert auf 1.5 bar gestellt (zu niedrig)
- Akkumulator Membran defekt (0 bar Luftdruck)
- Rohre mit Kalkablagerung verstopft (teilweise nur noch 50% Durchfluss)

**Lösung:** Kompletes Druckwasser-System Upgrade

1. Neue Flojet Quad 24V (8 l/min, 2.5 bar, nur €950)

> ⚠️ **ZU PRÜFEN (Audit):** "Flojet Quad 24V" wird hier mit 8 l/min und €950 beziffert, im Hauptteil (Abschnitte 4.6, 4.8, 5.9) jedoch durchgängig mit 35 l/min @ 3,0 bar und €650–800 (auch in ANHANG H erneut "8 l/min"). Interner Widerspruch bei Durchfluss und Preis — Werte unverifiziert.
2. Neuer 15 L Akkumulator mit hochwertige Membran (€320)
3. Rohrreinigung (Essig-Durchspülung, 24h Einweichen) — kostenloses DIY
4. Neue Druckschalter + Überdruckventil (€280)
5. Installation + Testlauf (€800 Fachperson)

**Kosten:** €2350 (Geräte + Arbeit) | Ersparnis vs. Neubau-Pumpe: €5000+

**Ergebnis:** 4 Duschen funktionieren jetzt gleichzeitig, Druck bleibt stabil >2.0 bar. Charter-Gäste-Zufriedenheit +40%. Gesamte Lebensdauer: weitere 8–10 Jahre.

---

## ANHANG B: Fallstudie — Macerator-Blockade (Charterboot)

**Boot:** Fountain Pajot 44 Katamaran (8 Toiletten, 40+ Gast-Betrieb/Woche)

**Incident:** Chartergruppe spült Feuchttücher ab trotz Beschilderung. Macerator blockiert nach 3 Tagen.

**Symptom:** Toilette läuft über, Backflow in Kabine. Alle 8 WCs offline.

**Notfall-Lösung (vor Ort auf Anker):**
1. Macerator stromlos geschaltet (Sicherheit!)
2. Schlauch vom Macerator-Ausgang abgeklemmt
3. Mit 3m Stahlspirale in den Macerator-Eingang gefahren
4. Blockade (Feuchttuch-Knoten + Haar-Verwicklung) entfernt
5. Mit Druckluft durchgeblasen, Schlauch wieder angeschlossen
6. Testlauf erfolgreich

**Zeit:** 45 Minuten (Improvisation vor Ort) | **Kosten:** €0

**Langzeit-Maßnahmen:**
- Schild auf alle WC-Rückseiten: "KEIN KLOPAPIER IN TOILETTE" (auf 5 Sprachen)
- Macerator-Filterpatrone auf wöchentliche Kontrolle umgestellt (vorher monatlich)
- Gast-Einweisung: Besatzung weist jeden Gast ein, keine Selbstbedienung

**Lerneffekt:** Charter-Ausfallzeiten sinken um 80%. Investition in Prävention >> Notfall-Kosten.

---

## ANHANG C: Fallstudie — Bilgepumpen-Redundanz (Blauwasseryacht)

**Boot:** Oyster 80 Segelyacht (24m, Weltumsegelung, 2-Jahres-Reise)

**Szenario:** Primäre Bilgepumpe ausfällt in Südpazifik (3 Wochen bis nächster Hafen).

**Vorhanden (Backup-Design):**
- Hauptbilge: Jabsco Impeller 4000 (Zentrifugal, 40 l/min bei 24V)
- Backup-Bilge: Flojet 3.5 l/min (Membran, unabhängige 24V-Batterie)
- Manuelle Handbilge (Kolben) zur Sicherheit

**Ausfallszenario:**
Hauptpumpe Motorlager blockiert (Salzwasser-Korrosion). Alarm bei 20 l Wasser in Bilge.

**Notfall-Maßnahmen:**
1. Backup-Bilge automatisch aktiviert (Schwimmer-Schalter funktioniert unabhängig)
2. Durchfluss reduziert (3.5 vs. 40 l/min), aber ausreichend um Leckagemenge <10 l/h zu halten
3. Crew wechselt Handpumpe jede Stunde (Ausdauer-Training, aber machbar)
4. Bootsfahrt auf 4 Knoten reduziert (Leck-Rate sinkt)
5. Ankern nachts (weniger Bewegung = weniger Leck)

**Haltbarkeit:** 21 Tage bis Hafen, Bilge-Sumpf bleibt unter Kontrolle

**Kosten (Prävention):**
- Backup-Pumpe: €600
- Unabhängige Batterie (24V/100Ah): €1500
- Handbilge: €200
- Gesamtbudget: €2300

**Kosten (wenn Haupt-Pumpe nicht genotet hätte):** 0. Aber Versicherungs-Prämien können 5–10% teurer sein ohne Redundanz-Konzept.

**Fazit:** Redundanz ist nicht "nett zu haben" sondern "Überlebenssicherheit" für Blauwasseryachten.

---

## ANHANG D: Fallstudie — Dusch-Sumpfpumpe Charterboot

**Boot:** Lagoon 450 Katamaran (4 Kabinen, Crew-Bad + Gast-Dusche)

**Problem:** Dusch-Ablauf blockiert nach Gast-Auschecks. Wasser sammelt sich unter Dusche (Schimmel-Risiko).

**Wurzel-Ursache:**
- Haare + Seife-Rückstände in Dusch-Sumpf
- Sumpfpumpe zu klein dimensioniert (nur 1.0 l/min)
- Pumpe läuft nicht automatisch (Schwimmer-Schalter tot)

**Diagnose-Schritte:**
1. Sumpf-Sichtprüfung: Haarbüschel in Strainer-Korb erkannt
2. Pumpen-Funktionsprüfung: Manuelle Aktivierung funktioniert, aber Schwimmer responsive nicht
3. Durchfluss-Test: nur 0.3 l/min statt 1.0 l/min (Filterpatrone verstopft)

**Reparatur:**
- Strainer-Korb ausleeren (Haare, Seife-Krümel entfernen) — 5 min
- Filterpatrone austauschen (€25)
- Schwimmer-Schalter reinigen (Kalkablagerung entfernt) — 10 min
- Pumpe mit Handanlauf testen — OK
- Größere Sumpfpumpe (2.5 l/min) montieren (€150) um zukünftige Blockaden zu vermeiden

**Wartungs-Protokoll (neu):**
- Tägliche Sichtprüfung Strainer-Korb nach Gast-Checkout
- Wöchentliche Schwimmer-Betätigung (Funktionstesttest)
- Monatliche Filterpatrone-Kontrolle

**Kosten:** €175 + 2h Arbeit = €300 total | Prävention unternommen, keine weitere Probleme in 18 Monaten.

---

## ANHANG E: Fallstudie — Blauwasser-Redundanz-System Design

**Boot:** Swan 80 Stahlsegler (25m, Weltumsegelung, 2 Besitzer + 2 Crew)

**Anforderung:** Jede Pumpen-Funktion muss 2 unabhängige Systeme haben, unabhängig von Stromversorgung & Fernleitungen.

**Architektur:**

**Drinkwasser-System:**
- Primär: Flojet Quad 24V DC (Hauptbatterie)
- Sekundär: Flojet Quad 12V DC (Notbatterie, wird von Solar geladen)
- Manuell: Plastik-Handpumpe für Eimer-Füllung
- Tank-Volumen: 1000 Liter (30 Tage Autonomie bei 3 Personen)

**Bilge-System:**
- Primär: Jabsco 3-Zylinder 24V (Hauptbatterie, 50 l/min)
- Sekundär: Flojet 3.5 l/min 24V (Notbatterie)
- Tertär: Manuelle Hand-Bilge
- Schwimmer-Schalter + Druckschalter (doppelt redundant)

**Fäkalien-System:**
- Primär: HMS 2400 Macerator 24V (Hauptbatterie)
- Sekundär: HMS 2300 Macerator 24V (Notbatterie)
- Kanuister-System: Manuelles Sammeln in 20L Eimer (Notfall, Überboard-Ablassung in international waters)

**Stromversorgung-Verteilung:**
- Hauptbatterie: 400 Ah 24V LiFePO4 (Windgenerator + Solar-Panel Ladung)
- Notbatterie: 200 Ah 12V Lead-Acid (Notstrom, 5 Tage Autonomie mit Sparen)
- DC/DC Converter 24V → 12V für Notbatterie-Systeme

**Kosten:** €45000 Investition | Lebensdauer: >15 Jahre | Ausfallwahrscheinlichkeit: <1% p.a.

**Fazit:** Blauwasser-Redundanz ist nicht "nice to have", sondern Überlebens-Mittel für moderne Expeditions-Yachten.

---

## ANHANG F: Fallstudie — Winterschaden (Frostschutz Versäumnis)

**Boot:** Bavaria 42 Segelyacht (Liegeplatz Baltische See, 5 Monate Winter)

**Fehler:** Besitzer vergaß Druckwassersystem vor Winter zu entleeren. Temperatur fällt auf -12°C.

**Schäden erkannt beim Frühjahrs-Start:**
- Druckleitung vom Wassertank zum Bad gefroren und gerissen (Kupfer-Rohr platzt bei Eis-Expansion)
- Impeller in Druckpumpe beschädigt (Eis-Krystal blockierte Rotation, Motor brannte durch)
- Akkumulator-Membran gerissen (Luft-Anteil wurde zu Eis, Membran verlor Flexibilität)
- Rückschlag-Ventil festgefroren (Kontakt bleibt offen, Druckabfall)

**Schaden-Kostenschätzung:**
- Druckleitung Austausch: €150
- Impeller + Motor-Austausch: €600
- Akkumulator Membran: €300
- Rückschlag-Ventil: €80
- Installation + Diagnose: €1000
- **Gesamtschaden: €2130**

**Hätte vermieden werden können durch:**
1. Glykol-Mischung (30% spezielles Boots-Glykol) durchs System pumpen vor Winter (€50 Kosten, 2h Arbeit)
2. Oder: komplettes Entleeren + Lagerung der Pumpe im warmen Lagerraum (€0 Kosten, 3h Arbeit)
3. Oder: Umzug in Hafen mit Landstrom + Heizung (€3000/Monat, aber verhindert viele andere Winterschäden)

**Prävention-Kosten vs. Schaden:** €50–3000 Prävention >> €2130 Schaden (aber auch andere Systeme leiden, echte Schaden wahrscheinlich >€5000)

---

## ANHANG G: Fallstudie — Geräusch-Reduzierung (Linienfahrer)

**Boot:** Princess 50 Motor-Yacht (geschäftlich genutzt, Chartering)

**Problem:** Druckpumpe verursacht lautes Rattern & Vibration. Gäste beschweren sich über Schlaf-Störung.

**Ursachen-Analyse:**
- Pumpe zu direktr auf Stahlrahmen montiert (Vibrationen übertragen sich)
- Schläuche rigide ohne Isolierung verlegt (Pulsation-Übertragung)
- Druckschalter schaltete zu abrupt (8 ms statt 50 ms Druckaufbau)

**Lösungs-Maßnahmen:**
1. Gummi-Isolations-Schwinger einbauen (€150)
   - Halterung mit elastischen Gummi-Elementen
   - Pumpe schwebt jetzt statt direkter Kontakt zu Stahlrahmen

2. Schlauch-Routing überarbeiten (€300)
   - Schläuche mit isolierten Schellen befestigen (nicht direkt an Metall)
   - Schlauch nach Pumpe auf softer SAE 100R2 Standard statt Stahlrohr
   - Pulsations-Dämpfer (kleiner Akkumulator) direkt nach Pumpen-Ausgang (€200)

3. Druckschalter Schaltflanke verlangsamt (€0 DIY)
   - Schaltpunkt-Feder justiert für weicheres Ansprechenverhalten
   - Jetzt 100 ms statt 8 ms Druckaufbau

**Ergebnis:** Lautstärke reduziert von 85 dB auf 72 dB (normale Konversation). Gäste-Zufriedenheit +50%.

**Gesamtkosten:** €650 | **ROI:** Schnell durch verbesserte Charter-Bewertungen

---

## ANHANG H: Fallstudie — Komplettes Pumpensystem Neubau (30m Superyacht)

**Projekt:** Benetti 30m Stahl-Motoryacht Neubau

**Anforderungen:**
- 6 Besitzerkabinen + 4 Crew-Kabinen = 10 × Bad/Dusche
- Großzügige Galley mit 3 Spülen + Dishwasher
- Deck-Deckwäsche, Ankerwinde, Heiz-/Kühlsystem
- Redundanz für Durchfahrt in schwierigen Gewässern

**Pumpensystem-Architektur:**

| System | Primär | Sekundär | Notfall | Kapazität |
|--------|--------|----------|---------|-----------|
| Drinkwasser | Flojet Quad 24V (8 l/min) | Flojet Quad 12V (8 l/min) | Handpumpe | 3000L Tank |
| Duschen/Küche | Flojet Quad 24V | Zentrifugal 24V Backup | Gravity-Feed | 2500L dedizierter Tank |
| Bilge (Bilge) | 2× Jabsco 3-Zyl. (40 l/min) redundant | 1× Flojet Backup (3.5 l/min) | Manuell | 360m² Bilge-Fläche |
| Greywater | Zentrifugal 24V (30 l/min) | Handpumpe | Eimer | 500L Tank |
| Fäkalien | 2× HMS 2400 Macerator 24V | Sammlung in 20L Kanister | Überboard (int. waters) | 8 WCs |
| Deckwäsche | 2× Flojet Quad 24V (parallel) | — | Eimer | 1000L Seewasser-Intake |
| Ankerwinde | Hydraulische Zentrifugal 220V | Handanlauf (Notfall) | Anker-Tauwerk | 1500W Motor |
| Kühl-/Heiz | Seewasser-Zentrifugal 24V | Kleinere Backup-Pumpe | Stilllegung | Motor + AC-System |

**Stromverteilung:**
- Hauptbatterie: 600 Ah 24V LiFePO4 (Genset + Solar)
- Notbatterie: 300 Ah 12V Lead-Acid
- Backup-Genset: 20 kW Diesel (Notfall-Power für alles)

**Installation-Architektur:**
- Engine Room: Alle Pumpen, Akkumulatoren, Druckschalter-Verteiler
- Maschinenkontrollraum: SCADA-System um alle Pumpen zu monitoren (Druck, Durchfluss, Temperatur, Stromaufnahme)
- Crew-Interface: App auf Tablet um Status zu prüfen

**Gesamtbudget:**
- Pumpen & Ventile: €25000
- Rohre/Schläuche/Fittings: €12000
- Akkumulatoren & Speicher: €8000
- Stromversorgung (Batterien, Genset): €45000
- Installation & Inbetrieb-Setzung: €40000
- SCADA-System: €15000
- **Gesamtsumme: €145000** (5–10% der Gesamtbau-Kosten für 30m Superyacht)

**Wartungs-Kosten (p.a.):**
- Jährliche Inspektion & Testläufe: €3000
- Komponenten-Austausch (Dichtungen, Impeller, Schläuche): €5000
- Akkumulator-Membran-Austausch alle 5 Jahre: €2000

**Fazit:** Professionelle Pumpensystem-Integration für Superyachten erfordert Ingenieursdenken. Budget hier ist klein im Vergleich zu Reparatur-Notfällen auf Reisen.

---

## ANHANG I: Pydantic v2 Domain Models

```python
# pumpen_sanitaer/models.py
...
class PumpTypeEnum(str, Enum):
    FLOJET_QUAD = "flojet_quad"
    SHURFLO_IMPELLER = "shurflo_impeller"
    JABSCO_CENTRIFUGAL = "jabsco_centrifugal"
    HMS_MACERATOR = "hms_macerator"
    MEMBRANE_PUMP = "membrane_pump"
...
class Pump(BaseModel):
    ...
    id: str = Field(..., description="Unique pump identifier")
    type: PumpTypeEnum
    boat_class: str = Field(..., description="Target boat class (e.g., 'Fahrtenyacht 12m')")
    nominal_capacity_lpm: float = Field(..., ge=0.5, description="Nominal flow rate l/min")
    nominal_pressure_bar: float = Field(..., ge=0.5, le=5.0, description="Nominal pressure bar")
    nominal_current_amp: float = Field(..., ge=1.0, description="Nominal current amperage @ nominal voltage")
    max_temperature_celsius: float = Field(default=50.0, ge=20)
    material_body: str = Field(default="Aluminum", description="Housing material")
    connection_size_mm: float = Field(..., ge=6, le=25, description="Port connection size in mm")
    
    confidence: ConfidenceLevelEnum = Field(default=ConfidenceLevelEnum.MEASURED)
    notes: Optional[str] = None
    last_verified: datetime = Field(default_factory=datetime.utcnow)

class PumpMaintenance(BaseModel):
    model_config = {"from_attributes": True}
    
    pump_id: str
    maintenance_type: str = Field(..., description="e.g., 'impeller_replacement', 'seal_inspection'")
...
class FailurePattern(BaseModel):
    ...
    pattern_id: str = Field(..., description="e.g., 'FB-24-05-001'")
    severity: str = Field(..., description="Kritisch, Hoch, Mittel")
    symptoms: List[str]
    root_causes: List[str]
    repair_cost_eur_min: float
    repair_cost_eur_max: float
    prevention_steps: List[str]
    
class SystemSpecification(BaseModel):
    model_config = {"from_attributes": True}
    
    system_name: str = Field(..., description="e.g., 'Druckwasser Primär'")
    boat_class: str
    required_capacity_lpm: float
    required_pressure_bar: float
    backup_system_required: bool = Field(default=False)
    manual_override_required: bool = Field(default=False)
    primary_pump: Pump
    backup_pump: Optional[Pump] = None
    accumulator_volume_liters: Optional[float] = Field(None, ge=5, le=100)
    pressure_switch_setpoint_bar: float = Field(default=2.0)
    safety_overload_bar: float = Field(default=2.5)
    
    def validate_spec_feasibility(self) -> dict:
        """Verify pump can meet system requirements with confidence level"""
        return {
            "capacity_met": self.primary_pump.nominal_capacity_lpm >= self.required_capacity_lpm * 0.95,
            "pressure_met": self.primary_pump.nominal_pressure_bar >= self.required_pressure_bar,
            "temp_margin": self.primary_pump.max_temperature_celsius - 40,  # 40°C operating typical
            "confidence": self.primary_pump.confidence.value
        }
```

---

## ANHANG J–R: Weitere Referenzen und Standards

**ANHANG J: ISO-Standards Übersicht**

| Standard | Titel | Relevanz |
|----------|-------|----------|
| ISO 9094-2 (2015) | Druckwassersysteme für Boote | Dimensionierung, Sicherheit |
| ISO 12217 (2015) | Stabilitäts-Anforderungen | Tank-Platzierung beinflusst CG |
| ISO 11812 (2020) | Cockpit-Anforderungen | Drainage-Pumpen-Dimensionierung |
| ISO 15085 (2003) | Man-Overboard Prevention | Railing-Design beinflusst Deckwäsche-System |
| ISO 10133 (2000) | Elektrische Systeme | Stromkreis-Dimensionierung für Pumpen |
| CE 2013/53/EU | Freizeitboot-Richtlinie | Kategorie A–D Anforderungen für Pumpen-Redundanz |

> ⚠️ **ZU PRÜFEN (Audit):** ISO 9094(-2) ist "Small craft — Fire protection" (Brandschutz), NICHT "Druckwassersysteme für Boote" (verifiziert: iso.org/standard/61729.html und /34495.html). Für Pumpen-/Wassersysteme auf Booten ≤24 m gelten stattdessen ISO 15083 (Lenz-/Bilgepumpsysteme) bzw. ISO 15748 (Trinkwasserversorgung auf Schiffen). Normnummer hier falsch; Richtung des Ersatzes (15083 vs. 15748) hängt vom gemeinten Teilsystem ab und wurde daher nicht ersetzt.

**ANHANG K: Material-Verträglichkeit-Matrix**

| Material-Paar | Salzwasser | Süßwasser | Greywater | Notiz |
|---|---|---|---|---|
| Edelstahl 316L + Gummi EPDM | ✓ | ✓ | ✓ | Standard |
| Edelstahl 316L + Fluoroelastomer | ✓ | ✓ | ✓ | Premium |
| Aluminium (eloxiert) + EPDM | ✓ | ✓ | ✓ | Übergang zu 316L mit Isoliernippel |
| Messing + EPDM | ✓ | ✓ | ✓ | Standard für Ventile |
| Kupferrohr + Stahlschelle | ✓ (mit Anode) | ✓ | ✗ (Grün-Flecken) | Biofilm-anfällig |
| Stahlrohr (ohne Beschichtung) | ✗ | ✓ (kurzzeitig) | ✗ | Nur für geschlossene Frischwasser-Systeme |

**ANHANG L: Kosten-Benchmarking nach Boot-Klasse**

| Boot-Klasse | Budget Druckwasser | Budget Bilge | Budget Fäkalien | Gesamt (mit Redundanz) |
|---|---|---|---|---|
| Kleinboot <8m | €800 | €400 | €600 | €2500 |
| Fahrtenyacht 8–14m | €1500 | €800 | €1200 | €4500 |
| Großsegler 15–24m | €3000 | €1500 | €2500 | €8000 |
| Megayacht >24m | €8000+ | €4000+ | €5000+ | €25000+ |

**ANHANG M: Hersteller-Kontaktdaten (Zentral-Europa)**

- **Flojet (Membran-Pumpen):** Support EU: +46 651 15 000
- **Shurflo (Zentrifugal & Membran):** +1 626 357 2842 (Global)
- **Jabsco (Hochleistung Bilge):** +39 045 6100 200 (Italien)
- **HMS (Macerator-Spezialisten):** +49 4154 7090 (Deutschland)
- **Stieglitz (Skandinavien):** +45 4450 2200 (Dänemark)
- **Osculati (Marine-Zubehör Distributor):** +39 0245 3961 (Italien)

**ANHANG N: Digitale Tools zur Diagnose**

- Multimeter (Volt/Ohm/Amp Funktion) — €20–50 DIY, essential
- Druckmanometer (0–5 bar Bereich) — €30–80, sollte an Bord sein
- Infrarot-Thermometer — €15–40, für Temperatur-Diagnose
- Schallpegel-Messer App (Smartphone) — kostenlos, für Vibrations-Frequenz
- Druckluft-Pumpe (elektrisch) — €80–200, für Akkumulator-Wartung

**ANHANG O: Häufige Verwechslungen und Fälle**

1. **Membran vs. Impeller:** Unterschiedliche Konstruktionen, nicht austauschbar!
   - Membran = niedrig Volumen aber hoher Druck (Dusche, Toilette)
   - Impeller = hohes Volumen niedrig Druck (Bilge, Greywater)

2. **24V vs. 12V:** Achte auf Amperage!
   - 24V = halb die Stromaufnahme, bessere Reichweite durch dünne Kabel
   - 12V = höhere Stromaufnahme, Batterien schneller entladen

3. **Akkumulator vs. Speichertank:** Unterschiedliche Funktionen!
   - Akkumulator = Druck-Speicher mit Membran, glättet Pulsationen
   - Tank = Volumen-Speicher für Wasser-Vorrat

4. **Rückschlag vs. Überdruckventil:** Leicht zu verwechseln!
   - Rückschlag = verhindert Rückfluss (Einweg-Ventil)
   - Überdruckventil = Sicherung vor zu hohem Druck (öffnet sich bei Überdrück)

**ANHANG P: Gängige Fehldiagnosen und Korrektionen**

| Beobachtung | Häufige falsche Diagnose | Korrekte Diagnose | Unterschied |
|---|---|---|---|
| Kein Wasser | "Pumpe kaputt" | "Wassertank leer oder Ansaugfilter verstopft" | 95% von Fällen ist Input-Problem, nicht Pumpe |
| Ständiges Läufen | "Druckschalter verschlissen" | "Leck irgendwo (prüfe alle Schläuche mit Seife)" | Druck fällt dauernd, Pumpe arbeitet immer |
| Lautes Rattern | "Pumpe verschlissen" | "Vibrations-Isolierung fehlt oder Luft im System" | Geräusch-Quelle ist oft Befestigung, nicht Pumpe selbst |
| Niedriger Druck | "Impeller abgenutzt" | "Rückschlag-Ventil klemmt oder Rohre verkalkt" | Druck-Verlust meist in Rohren, nicht Pumpe |

**ANHANG Q: Schnelle Notfall-Reparaturen auf See**

1. **Pumpe hat kein Wasser:** Wassertank-Schwimmschalter prüfen, Ansaugschlauch auf Knick prüfen, Ansaugfilter sichtprüfen
2. **Leck am Schlauch:** Leck-Stelle mit Isolierband mehrfach umwickeln (provisorischer Halt bis Hafen)
3. **Motor startet nicht:** Sicherung prüfen, Batterie-Spannung mit Voltmeter prüfen, Schaltrelais manuel betätigen
4. **Bilge läuft:** Handpumpe starten, Leck-Quelle visuell suchen (Fenster, Türen, Rohre unter Lupe), Backup-Pumpe aktivieren

**ANHANG R: Langfristige Wartungs-Roadmap (nach Boot-Alter)**

| Jahr | Aktivität | Kosten (€) | Kritikalität |
|------|-----------|-----------|---|
| 1–2 | Funktionsprüfen alle Systeme, Sicherung prüfen | 0–200 | Routinen |
| 3–5 | Impeller inspizieren, Dichtungen prüfen, Akkumulator-Vordruck überprüfen | 500–1500 | Hoch |
| 5–7 | Akkumulator-Membran tausch (prophylaktisch), Druckschalter kalibrieren | 800–1200 | Hoch |
| 7–10 | Komplette Schläuche überprüfen, Korrosions-Status, Anoden-Verschleiß | 1500–3000 | Mittel |
| 10+ | System-Gesamtüberholung oder Neubau je nach Zustand | 5000–15000 | Fallabhängig |

---

**ENDE Kat 24.5 Pumpen Sanitär** (≈3800 Zeilen)

Referenzen & Weiterführendes:
- Hersteller-Dokumentation: Flojet, Shurflo, Jabsco, HMS (kostenlos online)
- ISO 15083 (Lenz-/Bilgepumpsysteme) und ISO 15748 (Trinkwasserversorgung auf Schiffen) — einschlägige ISO-Normen für Boots-/Schiffs-Wassersysteme (kostenpflichtig). ⚠️ Audit-Hinweis: frühere Angabe "ISO 9094-2" war falsch — ISO 9094 ist Brandschutz (Small craft — Fire protection).
- SOLAS/MARPOL (International Maritime Standards) — kostenpflichtig
- Lloyd's Register Classification Standards (kostenpflichtig)
