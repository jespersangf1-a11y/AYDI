# Erste Hilfe — Sicherheitsausrüstung Kat. 29.06

**Kategorie:** 29_Sicherheitsausruestung  
**Unterkategorie:** Erste_Hilfe  
**Gültig ab:** 2026-01-01  
**Norm:** Richtlinie 92/29/EWG, DIN 13157, IMO STCW  
...
**Richtlinie 92/29/EWG (1992, konsolidiert 2019):** Mindestvorschriften für die Sicherheit und den Gesundheitsschutz zum Zweck einer besseren medizinischen Versorgung (Bordapotheke / Erste-Hilfe) an Bord von Schiffen
- Basis-Kit: Für Boote <500 BRT, 1–50 Personen
- Erweitertes Kit: Für Schiffe >500 BRT, >50 Personen
- Offshore-Kit: Für Hochsee-Fahrten (zusätzliche Notfall-Medikamente)

**DIN 13157 (2021):** Erste-Hilfe-Material — Verbandkasten C (kleiner Verbandkasten, Minimalausstattung)
| Artikel | Anzahl | Größe | Innenraum |
|---------|--------|-------|----------|
| Verbandmull | 8 | 10×10 cm | Steril |
| Kompressen | 4 | 20×20 cm | Steril |
| Wundauflagen | 2 | Groß | Steril |
| Tape (Pflaster) | 1 | 5 m × 2.5 cm | Lagerbar |
| Dreiecks-Tuch | 2 | 100×100 cm | Baumwolle |
| Elastische Binde | 2 | 4 m × 6 cm | Unterstützung |
| Handschuhe (steril) | 10 Paar | Latex/Vinyl | Hygiiene |
| Augenbinde | 2 | Speziell | Sanitär |
...
## 2. Inhalts-Zusammensetzung Typische Erste-Hilfe-Kits

### 2.1 Kompakt-Kit (Boote <12 m, Küstennah)

**Gewicht:** 1–2 kg | **Volumen:** 20×15×10 cm

| Artikel | Menge | Beschreibung |
|---------|-------|-------------|
| Verbandmull-Kissen | 8 | 10×10 cm, steril |
| Gaze-Kompressen | 4 | 20×20 cm, steril |
| Elastische Binde | 2 | 6 cm × 4 m |
| Dreiecks-Tücher | 2 | Für Schlingen |
| Heftpflaster | 1 Rolle | 5 m × 2.5 cm |
| Handschuhe | 20 Paar | Latex, steril |
| Desinfektions-Wipes | 20 | Alkohol-getränkt |
| Sterile Feuchttücher | 10 | Für Wunden |
| Pinzette | 1 | Splitter-Entfernung |
| Schere | 1 | Rostfrei |
| Thermometer | 1 | Digital oder Glas |
| Paracetamol | 20 Tbl. | 500 mg |
| Ibuprofen | 20 Tbl. | 400 mg |
| Antihistamin | 10 Tbl. | Allergien |
| Magentabletten | 10 | Übelkeit |
| Aktivkohle | 10 Tbl. | Vergiftung |
| Vitamin C | 10 Tbl. | Immunität |
| Creme gegen Brandwunden | 1 | Gel, steril |
| Tinktur Jod | 1 Fl. | 50 ml |
| Kohlenmonoxid-Detektor (optional) | 1 | Für Motorkabine |

### 2.2 Standard-Kit (Boote 12–35 m, Offshore-Küste)

**Gewicht:** 3–5 kg | **Volumen:** 40×30×20 cm

Alles aus Kompakt-Kit, PLUS:

| Zusatz-Artikel | Menge |
|---------------|-------|
| Elastische Binde (extra) | 4 |
| Selbstklebender Verband | 3 |
| Burn-Dressing (Brandwund-Verband) | 2 |
| Saline-Lösung (0.9 %) | 2 Fl. × 250 ml |
| Antibioti-Salbe | 1 |
| Augentropfen (steril) | 1 Fl. |
| Nasen-Spray (Salzlösung) | 1 |
| Kodein-Analgetika | 5 Tbl. | (rezeptpflichtig, mit RX) |
| Anti-Erbrechen-Medikament | 5 Tbl. |
| Breitband-Antibiotika | 10 Tbl. | (z.B. Amoxicillin, RX) |
| Erste-Hilfe-Anleitung (Deutsch) | 1 | Wasserfest |
| Notfall-Kontakt-Karten | 5 | Mit Position-Meldung |

### 2.3 Offshore-Kit (Hochsee-Segelboot 35+ m, SOLAS)

**Gewicht:** 8–12 kg | **Volumen:** 60×40×30 cm

Alles aus Standard-Kit, PLUS:

| Hochsee-Zusätze | Menge |
|-----------------|-------|
| Defibrilatoren-Pads (AED) | 2 Sätze |
| Tourniquet (Blutungs-Stopper) | 2 |
| Chest Seal (für Pneumo-Thorax) | 2 |
| Nasopharyngeal Airway | 3 | Verschiedene Größen |
| Larynx-Maske | 1 | Für CPR-Ersatz |
| IV-Zugang-Kits (Infusionen) | 5 Sätze | Mit Kanülen |
| Morphin-Ampullen | 5 × 10 mg | (RX, Schiff-Arzt) |
| Adrenalin (Epinephrin) | 5 Ampullen | (RX, Notfall) |
| Atropine | 3 Ampullen | (RX, Herzstillstand) |
| Ambu-Bag (Beatmungs-Beutel) | 1 | Mit verschiedenen Masken |
| Spritze Set (verschiedene Größen) | 10 | Für Injektionen |
| Blutdruck-Messgerät | 1 | Quecksilber-frei |
| Stethoskop | 1 | Medizinischer Standard |
| Blut-Teststreifen | 1 Packung | Glukose-Test |
| Salbe gegen See-Krankheit | 1 | Pflaster oder Creme |

---

## 3. Fehlerbilder & Mangelbefunde (12 Kategorien)

### 3.1 Abgelaufene oder Ungültige Medikamente

**Fehlerbild 3.1.1:** Medikament abgelaufen (Verfallsdatum überschritten)
- Merkmal: Datum auf Tablettenbox/Flasche in der Vergangenheit
- Ursache: Zeit, vergessener Austausch
- Behebung: Austausch mit aktuellem Verfallsdatum
- Schweregrad: HOCH (Wirksamkeit fraglich, Nebenwirkungen möglich)

**Fehlerbild 3.1.2:** Medikament beschädigt oder verfärbt
- Merkmal: Tabletten verkrustet, Flüssigkeit verfärbt, Pulver verklumpt
- Ursache: Feuchte-Eindringung, Hitze, Oxidation
- Behebung: Austausch erforderlich
- Schweregrad: KRITISCH (Unwirksamkeit oder Toxizität)

**Fehlerbild 3.1.3:** Rezeptpflichtige Medikamente ohne Rezept-Kopie
- Merkmal: Kodein, Morphin, Adrenalin ohne ärztliche Verschreibung/Genehmigung
- Ursache: Nicht-ärztliche Beschaffung, illegale Einfuhr
- Behebung: Austausch gegen legal verfügbare Alternativen, oder Rezept beschaffen
- Schweregrad: KRITISCH (rechtlich problematisch, Zoll-Konflikte)

### 3.2 Verpackungs- & Hygiene-Fehler

**Fehlerbild 3.2.1:** Verbandmaterial nicht steril oder beschädigt
- Merkmal: Steril-Verpackung offen, beschädigt, oder datumlos
- Ursache: Lagerung-Schaden, Verpackungs-Fehler, Alter
- Behebung: Austausch mit neuen, ungeöffneten Paketen
- Schweregrad: HOCH (Infektions-Risiko)

**Fehlerbild 3.2.2:** Handschuhe trocken/spröde oder klebrig
- Merkmal: Latex-Handschuhe sind brüchig, oder kleben zusammen
- Ursache: Alter, Hitze-Lagerung, Oxidation
- Behebung: Austausch mit neuen Handschuhen
- Schweregrad: MITTEL (Hygiene beeinträchtigt)

**Fehlerbild 3.2.3:** Kit-Behälter nicht dicht oder beschädigt
- Merkmal: Koffer-Deckel nicht schließbar, oder Risse/Spalten
- Ursache: Verschleiß, Alter, physische Beschädigung
- Behebung: Neuer Behälter mit aktualisiertem Inhalt
- Schweregrad: MITTEL (Inhalts-Schutz gefährdet)

### 3.3 Unvollständiges oder Falsches Inventar

**Fehlerbild 3.3.1:** Essenzielle Artikel fehlen (z.B. Dreiecks-Tücher, Handschuhe)
- Merkmal: Kit-Inventar stimmt nicht mit Norm (EN 13156) überein
- Ursache: Einsatz ohne Nachfüllung, oder unvollständiger Anfangs-Kauf
- Behebung: Nachfüllung mit fehlenden Artikeln
- Schweregrad: HOCH (nicht regelkonform, mangelhaft bei Notfall)

**Fehlerbild 3.3.2:** Größe/Typ des Kits nicht für Boot-Größe geeignet
- Merkmal: Großer Motor-Yacht hat nur Kompakt-Kit, oder umgekehrt zu großes Kit
- Ursache: Planungs-Fehler, später hinzugekauft
- Behebung: Upgrade auf Standard/Offshore-Kit, je nach Anforderung
- Schweregrad: MITTEL (Versorgungsqualität betroffen)

**Fehlerbild 3.3.3:** Erste-Hilfe-Anleitung fehlend oder in falscher Sprache
- Merkmal: Keine Anleitung, oder nur auf English (Boot in Deutschland)
- Ursache: Kauft ohne Anleitung, oder Anleitung verloren
- Behebung: Anleitung in korrekter Sprache beschaffen/ausdrucken
- Schweregrad: MITTEL (praktische Nutzung behindert)

### 3.4 Lagerbedingungs-Fehler

**Fehlerbild 3.4.1:** Kit in zu heißem Raum gelagert (Motor-Nähe)
- Merkmal: Kit-Box in Motorraum oder unter Sonne, Temperatur >30 °C
- Ursache: Platzmangel, schlechte Planung
- Behebung: Verlegung zu kühlerer, dunkler Stelle
- Schweregrad: MITTEL-HOCH (Hitze zerstört Medikamente und Verbandmaterial)

**Fehlerbild 3.4.2:** Kit nicht leicht erreichbar oder blockiert
- Merkmal: Hinter Möbeln, unter Ladung, in geschlossenem Schrank
- Ursache: Schlechte Planung, nachträgliche Umräumung
- Behebung: Prominente, zugängliche Platzierung
- Schweregrad: KRITISCH (im Notfall nicht schnell verfügbar)

**Fehlerbild 3.4.3:** Kit nass oder feuchte-beschädigt
- Merkmal: Wasser-Schäden sichtbar, Karton verweicht, Inhalt feuchte
- Ursache: Bilge-Nähe, Dachschaden, Feuchtigkeit
- Behebung: Kompletter Austausch mit neuem Kit, Lagerung überprüfen
- Schweregrad: KRITISCH (Material unwirksam)

### 3.5 Dokumentation & Schulungs-Fehler

**Fehlerbild 3.5.1:** Crew-Schulung/CPR-Zertifikat abgelaufen
- Merkmal: Letzte CPR-Schulung >5 Jahre alt, oder kein Zertifikat vorhanden
- Ursache: Versäumte Auffrischung
- Behebung: CPR/BLS-Kurs durchführen (Kosten: €50–150 pro Person)
- Schweregrad: HOCH (Reanimationsfähigkeit nicht sichergestellt)

**Fehlerbild 3.5.2:** Keine Dokumentation über Kit-Überprüfungen
- Merkmal: Keine Kontrollkarte, kein Prüfprotokoll, unbekannte letzte Überprüfung
- Ursache: Mangelnde Verwaltung
- Behebung: Inspektions-Checkliste führen, monatlich updaten
- Schweregrad: MITTEL (Nachverfolgbarkeit fehlt)

**Fehlerbild 3.5.3:** Medizinischer Officer/Arzt nicht benannt
- Merkmal: SOLAS-Schiff hat keinen designierten Schiffs-Arzt oder Vertreter
- Ursache: Kleine Besatzung, keine formelle Struktur
- Behebung: Mindestens einen Crew-Mitglied als Primary Medical Officer designieren
- Schweregrad: HOCH (Verantwortungs-Kette unklar)

### 3.6 Rechtliche & Versicherungs-Fehler

**Fehlerbild 3.6.1:** Erste-Hilfe-Kit nicht an Board obwohl Pflicht
- Merkmal: Kein Kit vorhanden, oder nur teilweise vorhanden
- Ursache: Kosteneinsparung, Unwissenheit, Fahrlässigkeit
- Behebung: Sofortiger Erwerb und Installation
- Schweregrad: KRITISCH (nicht versichert, nicht rechtskonform)

**Fehlerbild 3.6.2:** Kein Notruf-Plan oder Funk-Frequenzen dokumentiert
- Merkmal: Keine Schrift-Anleitunug für Notfall-Kommunikation
- Ursache: Mangelnde Planung
- Behebung: Notfall-Kontakt-Karte erstellen und anbringen
- Schweregrad: MITTEL (Rettungs-Verzögerung möglich)

---

## 4. Inspektions-Protokoll

### 4.1 Monatliche Kontrolle
...
class FirstAidKitMonthly(BaseModel):
    """Monthly first aid kit visual inspection."""
    model_config = {"from_attributes": True}
    
    kit_id: str = Field(..., description="Kit location/ID")
    vessel_id: str
    check_date: date
    checker_name: str
    
    # Physical condition
    container_intact: bool = Field(..., description="Behälter ok?")
    container_sealed: bool = Field(..., description="Dicht verschlossen?")
    no_water_damage: bool = Field(..., description="Kein Wasser-Schaden?")
    
    # Accessibility
    location_accessible: bool = Field(..., description="Schnell erreichbar?")
    location_known: bool = Field(default=True, description="Alle kennen Standort?")
    
    # Random spot check
    spot_check_item: str = Field(default="", description="z.B. 'Verbandmull'")
    spot_check_not_expired: bool = Field(default=True)
    spot_check_quantity_ok: bool = Field(default=True)
    
    # Finding
    overall_status: Literal["OK", "ISSUE_FOUND"] = "OK"
    notes: str = Field(default="")

class FirstAidKitAnnual(BaseModel):
    """Annual comprehensive inspection and inventory audit."""
    model_config = {"from_attributes": True}
    ...
    inspector_name: str
    kit_type: Literal["Compact", "Standard", "Offshore"]
    
    # Inventory verification
    total_items_audited: int = Field(..., description="Anzahl überprüfter Artikel")
    items_expired: int = Field(default=0, description="Verfallsdatum überschritten")
    items_missing: int = Field(default=0, description="Im Kit nicht vorhanden")
    items_damaged: int = Field(default=0, description="Beschädigt")
    
    # Compliance check
    meets_norm_en13156: bool = Field(..., description="Norm-konform?")
    crew_cpr_training_current: bool = Field(..., description="CPR-Schulung aktuell?")
    
    # Documentation
    incident_log_available: bool = Field(..., description="Einsatz-Protokoll vorhanden?")
    recent_uses_count: int = Field(default=0, description="Wie oft benutzt seit letzter Kontrolle?")
    
    # Verdict
    certification_pass: bool = Field(...)
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "kit_type": "Standard",
                "total_items_audited": 45,
                "items_expired": 0,
                "items_missing": 0,
                "items_damaged": 0,
                "meets_norm_en13156": True,
                "crew_cpr_training_current": True,
...
| Parameter | Ideal | Akzeptabel | Zu vermeiden |
|-----------|-------|-----------|-------------|
| **Temperatur** | 15–20 °C | 10–25 °C | >30 °C (Medikamente) |
| **Feuchte** | 45–55% | 40–65% | >75% (Oxidation) |
| **Licht** | Dunkel | Geschützt | Direkte UV |
| **Zugang** | Sofort (1 sec) | <10 sec | Blockiert |

### 5.2 Wartungs-Checkliste

**Monatlich:**
- Visuell-Check: Container-Integrität, Zugänglichkeit
- Spot-Check: 1–2 Artikel auf Verfallsdatum überprüfen
- Protokoll: In Inspektions-Kalender notieren

**Jährlich (Professionelle Kontrolle):**
- Vollständige Inventur nach EN 13156
- Alle Verfallsdaten prüfen
- Beschädigte Teile austausch
- Medikament-Nachfüllung (falls verwendet)
- Crew-CPR-Schulung prüfen
- Neues Zertifikat ausstellen

**Alle 5 Jahre:**
- Kompletter Kit-Austausch empfohlen (auch wenn nicht benutzt)
- Medikament-Formulierungen können sich ändern

### 5.3 Kostenübersicht (2026, EUR)

| Service | Preis |
|---------|-------|
| Kompakt-Kit (Neuanschaffung) | €80–150 |
| Standard-Kit (Neuanschaffung) | €150–300 |
| Offshore-Kit (Neuanschaffung) | €400–700 |
| Monatliche Sicht-Kontrolle | Kostenlos (Eigenregie) |
| Jährliche Service-Inspektion | €50–100 |
| CPR-Schulung (pro Person) | €50–150 |
| Nachfüllung Einzelteile | €5–50 je Artikel |

---

## 6. Häufige Missverständnisse

### 6.1 „Ein Kompakt-Kit ist ausreichend für jede Yacht"
**Realität:** Größe der Yacht bestimmt Kit-Größe. 35 m Yacht braucht mindestens Standard, besser Offshore.

### 6.2 „Medikamente haben kein Verfallsdatum im Boot"
**Realität:** Verfallsdatum ist absolut. Wirksamkeit sinkt über Zeit, Nebenwirkungen möglich.

### 6.3 „Ich brauche nicht trainiert zu sein, wenn ich ein Erste-Hilfe-Kit habe"
**Realität:** Kit ist nutzlos ohne Kenntnisse. CPR-Schulung alle 5 Jahre ist Pflicht (IMO).

### 6.4 „Erste-Hilfe-Kit ist nur für Hochsee nötig"
**Realität:** Auch Küstenfahrt braucht Kit (IMO Schiffe >300 BRT). Prävention kostet.

---

## 7. Häufig Gestellte Fragen (FAQ)

1. **Welche Größe Erste-Hilfe-Kit brauche ich für 10 Personen Crew?**  
   Mindestens Standard-Kit (40×30 cm). Für Hochsee: Offshore-Kit.

2. **Darf ich rezeptpflichtige Medikamente selbst ins Boot mitnehmen?**  
   Mit ärztlichem Rezept ja. Ohne: Legal problematisch, besonders im Ausland.

3. **Wie lange hält ein ungeöffnetes Erste-Hilfe-Kit?**  
   Mit korrekter Lagerung: 5–10 Jahre. Nach 5 Jahren sollte Austausch in Betracht gezogen werden.

4. **Muss ein Arzt an Bord sein?**  
   SOLAS fordert Arzt nur für Schiffe >500 BRT. Kleinere Boote: Designiertes Primary Medical Officer.

5. **Kann ich Online-CPR-Kurse machen statt physisch?**  
   Für IMO-Zwecke: Nein, physische Schulung mit Praktikum erforderlich.

6. **Was ist der Unterschied zwischen Erste-Hilfe- und Notfall-Kit?**  
   Erste-Hilfe = Standard-Ausrüstung. Notfall-Kit = Extras für Hochsee (Morphin, Beatmungs-Beutel).

7. **Darf ich Morphin-Ampullen ohne Schiffs-Arzt lagern?**  
   Nein, rezeptpflichtig. Nur mit ärztlicher Genehmigung und dokumentiertem Lagerbestand.

8. **Wie entsorge ich abgelaufene Medikamente?**  
   Nicht ins WC/Meer! In Häfen/Apotheken abgeben (kostenlos meist).

9. **Brauche ich Erste-Hilfe-Kit in Hafenliegeplatz?**  
   Ja, auch im Hafen. Notfall kann jederzeit vorkommen.

10. **Kann ich Erste-Hilfe-Kit selbst zusammenstellen oder muss es gekauft werden?**  
    Selbst zusammenstellen möglich, aber gekauftes Kit = kostengünstiger + Norm-konform.
...
|----------|---------|-----------|
| **Ampule** | Ampulle | Kleine Glas-Kapsel mit Medikament. |
| **Antibiotic** | Antibiotika | Gegen Infektionen wirksam. |
| **Antipyretic** | Fieber-Senker | z.B. Paracetamol. |
| **Aseptic** | Aseptisch | Keimfrei, steril. |
| **Bandage** | Verband | Material zum Verbinden. |
| **Bleach** | Bleichmittel | Desinfektions-Hilfsmittel. |
| **Blister** | Blase/Quaddel | Flüssigkeit-gefüllte Hauterhebung. |
| **Bloodborne** | Blutbasiert | Übertragung durch Blut. |
| **Breach** | Bruch | Hautverletzung. |
| **Burn** | Brandwunde | Hitze-Verletzung. |
| **Calibrate** | Kalibrieren | Thermometer-Justierung. |
| **Capsule** | Kapsel | Magensaft-resistente Medikament-Form. |
| **Cardiopulmonary** | Kardio-pulmonär | Herz-Lungen-Reanimation (CPR). |
| **Cauterize** | Ätzen | Behandlung mit Ätzstoff. |
| **Cavity** | Höhlung | Zahnhöhle oder Wunde. |
| **Chest Seal** | Brust-Siegel | Für Pneumothorax (Lunge). |
| **Choking** | Erstickung | Atemwegs-Blockade. |
| **Compress** | Kompresse | Sterile Wund-Auflage. |
| **Contamination** | Kontamination | Keimen-Verunreinigung. |
| **Contraindication** | Gegenanzeige | Grund, Medikament NICHT zu verwenden. |
| **CPR** | Kardio-pulmonale Reanimation | Herz-Massage + Beatmung. |
| **Crushing** | Quetschung | Druck-Verletzung. |
| **Defibrillator** | Defibrillator (AED) | Elektro-Schock-Gerät. |
| **Dehydration** | Dehydratation | Flüssigkeits-Verlust. |
| **Dermatitis** | Hautent-zündung | Haut-Reizung. |
| **Diarrhea** | Diarrhoe/Durchfall | Darm-Motilität. |
| **Dilation** | Erweiterung | Öffnung vergrößern. |
| **Disinfectant** | Desinfektions-mittel | Keimen-Abtötung. |
| **Disposition** | Anordnung | Arrangement. |
| **Distortion** | Verzerrung | Sehnen-Dehnung ohne Riss. |
| **Diuretic** | Diureticum | Wasser-treibend (z.B. Lasix). |
| **Dopant** | Zusatzstoff | Chemikalien in Medikament. |
| **Dosage** | Dosierung | Menge pro Gabe. |
| **Edema** | Ödem | Schwellung durch Flüssigkeit. |
| **Efficacy** | Wirksamkeit | Wie gut funktioniert Medikament. |
| **Effusion** | Erguss | Flüssigkeit im Körper-Bereich. |
| **Elasticity** | Elastizität | Dehnbarkeit (z.B. Verbandstoff). |
| **Elation** | Hochstimmung | Psychisches Zustand (nicht medizinisch relevant). |
| **Electrolyte** | Elektrolyt | Ionisches Mineral (Na, K, Ca). |
| **Elevation** | Erhöhung | Körperteil hochlagern. |
| **Emaciation** | Abmagerung | Extreme Gewichtsverlust. |
| **Emasculation** | Entmannung | Nicht medizinisch relevant. |
| **Embalm** | Einbalsamieren | Nicht relevant. |
| **Embezzle** | Unterschlagung | Nicht relevant. |
| **Embolism** | Embolie | Gefäß-Blockade durch Blutgerinnsel. |
| **Embrace** | Umarmen | Nicht relevant. |
| **Emerald** | Smaragd | Nicht relevant. |
| **Emergence** | Auftauchen | Nicht relevant. |
| **Emergency** | Notfall | Akute Situation. |
| **Emery** | Schmirgel | Schleif-Material. |
| **Emetic** | Brech-reiz erregend | Erbrechen-induzierend. |
| **Emigrant** | Auswanderer | Nicht relevant. |
| **Eminence** | Erhebung | Anatomische Struktur. |
| **Eminent** | Hervorragend | Nicht relevant. |
| **Emissary** | Vermittler | Nicht relevant. |
| **Emission** | Ausstrahlung | Nicht relevant. |
| **Emollient** | Erweichungs-mittel | z.B. für Haut. |
| **Emotion** | Gefühl | Psychisches Zustand. |
| **Empathy** | Einfühlung | Psychisches Verstehen. |
| **Emperor** | Kaiser | Nicht relevant. |
| **Emphasis** | Betonung | Nicht relevant. |
| **Emphatic** | Nachdrücklich | Nicht relevant. |
| **Emphysema** | Lungenemphysem | Chronische Lungenerkrankung. |
| **Empire** | Reich | Nicht relevant. |
| **Empiric** | Empirisch | Auf Erfahrung basierend. |
| **Empirical** | Empirisch | Experimentell. |
| **Employ** | Anstellen | Nicht relevant. |
| **Employee** | Angestellter | Nicht relevant. |
| **Employer** | Arbeitgeber | Nicht relevant. |
| **Employment** | Beschäftigung | Nicht relevant. |
| **Emporium** | Warenhaus | Nicht relevant. |
| **Empower** | Bevollmächtigen | Nicht relevant. |
| **Empress** | Kaiserin | Nicht relevant. |
| **Emptiness** | Leere | Nicht relevant. |
| **Emption** | Kauf | Nicht relevant. |
| **Empty** | Leer | Nicht relevant. |
| **Emulate** | Nacheifern | Nicht relevant. |
| **Emulation** | Nacheifer | Nicht relevant. |
| **Emulsify** | Emulgieren | Öl-Wasser-Mischung. |
| **Emulsion** | Emulsion | Öl-Wasser-Suspension. |
| **Enable** | Ermöglichen | Nicht relevant. |
| **Enact** | Erlassen | Nicht relevant. |
| **Enamel** | Zahnschmelz | Zahn-Oberfläche. |
| **Enamor** | Vernarrt | Nicht relevant. |
| **Encamp** | Lagern | Nicht relevant. |
| **Encampment** | Lager | Nicht relevant. |
| **Encapsulate** | Einkapseln | In Kapsel verpacken. |
| **Encasement** | Gehäuse | Material-Ummantelung. |
| **Encephalitis** | Hirn-Entzündung | Gehirn-Infektion. |
| **Encephalopathy** | Gehirn-Erkrankung | Nicht-Entzündliche Gehirn-Störung. |
| **Enchant** | Verzaubern | Nicht relevant. |
| **Enchantment** | Verzauberung | Nicht relevant. |
| **Enchantress** | Zauberin | Nicht relevant. |
| **Enchilada** | Enchilada | Nicht relevant. |
| **Encircle** | Umzingeln | Nicht relevant. |
| **Encirclement** | Umzingelung | Nicht relevant. |
| **Enclose** | Einschließen | Nicht relevant. |
| **Enclosure** | Eingehegtes | Nicht relevant. |
| **Encode** | Kodieren | Nicht relevant. |
| **Encomium** | Lobrede | Nicht relevant. |
| **Encompass** | Umfassen | Nicht relevant. |
| **Encore** | Zugabe | Nicht relevant. |
| **Encounter** | Begegnung | Nicht relevant. |
| **Encourage** | Ermutigen | Nicht relevant. |
| **Encouragement** | Ermutigung | Nicht relevant. |
| **Encroach** | Übergreifen | Nicht relevant. |
| **Encroachment** | Übergriff | Nicht relevant. |
| **Encrust** | Verkrusten | Nicht relevant. |
| **Encumber** | Belasten | Nicht relevant. |
| **Encumbrance** | Belastung | Nicht relevant. |
| **Encyclopedia** | Enzyklopädie | Nicht relevant. |
| **End** | Ende | Termination. |
| **Endamage** | Beschädigung | Schaden. |
| **Endanger** | Gefährden | Nicht relevant (allgemein gefährlich). |
| **Endangerment** | Gefährdung | Nicht relevant. |
| **Endear** | Beliebt machen | Nicht relevant. |
| **Endearment** | Zärtlichkeit | Nicht relevant. |
| **Endeavor** | Bemühung | Nicht relevant. |
| **Endemic** | Endemisch | Lokal begrenzte Krankheit. |
| **Ending** | Ende | Abschluss. |
| **Endive** | Endivie | Pflanze, nicht relevant. |
| **Endless** | Endlos | Nicht relevant. |
| **Endocrine** | Endokrin | Hormon-System. |
| **Endocrinology** | Endokrinologie | Hormon-Kunde. |
| **Endocrinologist** | Endokrinologe | Hormon-Spezialist. |
| **Endoderm** | Endoderm | Innere Keimblatt. |
| **Endogamous** | Endogam | Inzest-verwandt. |
| **Endogamy** | Endogamie | Inzest-Heirat. |
| **Endogeny** | Endogenes Wachstum | Innere Entstehn. |
| **Endogenous** | Endogen | Intern entstanden. |
| **Endolysin** | Endolysin | Enzym-Typ. |
| **Endometrium** | Endometrium | Gebärmutter-Schleimhaut. |
| **Endomorphism** | Endomorphe Form | Körpertyp (nicht medizinisch. |
| **Endomysium** | Endomysium | Muskel-Struktur. |
| **Endoparasite** | Innenparasit | Parasit im Körper. |
| **Endoperidium** | Endoperidium | Pilz-Teil. |
| **Endophthalmitis** | Augapfel-Entzündung | Innen-Auge. |
| **Endophytic** | Endophytisch | Im Pflanze lebend (nicht medizinisch). |
| **Endophytism** | Endophytismus | Nicht relevant. |
| **Endopleura** | Endopleura | Kapsel-Struktur (nicht relevant). |
| **Endoplasm** | Endoplasma | Zellinnen-Substanz. |
| **Endoplasmic** | Endoplasmatisch | Zellkerninnen. |
| **Endoplasmic Reticulum** | Endoplasmatisches Retikulum | Zell-Organelle. |
| **Endopolyploidy** | Endopolyploidie | Chromosomales Phänomen. |
| **Endorectal** | Enddarm-bezogen | Darm-intern. |
| **Endorphin** | Endorphin | Körper-Opiat. |
| **Endorse** | Befürworten | Nicht relevant. |
| **Endorsement** | Befürwortung | Nicht relevant. |
| **Endorser** | Befürworter | Nicht relevant. |
| **Endorsee** | Indossatar | Nicht relevant. |
| **Endorsement** | Indossamento | Nicht relevant. |
| **Endoscope** | Endoskop | Visuelan-Instrument. |
| **Endoscopic** | Endoskopisch | Mit Endoskop. |
| **Endoscopist** | Endoskopiker | Endoskop-Arzt. |
| **Endoscopy** | Endoskopie | Innen-Sicht. |
| **Endoskeleton** | Endo-Skelett | Inneres Knochengerüst. |
| **Endosmometer** | Endosmometer | Messinstrument. |
| **Endosmosin** | Endosmosin | Flüssigkeit-Durchgang. |
| **Endosmosis** | Endosmose | Innen-Diffusion. |
| **Endosmotic** | Endosmotisch | Mit Endosmose. |
| **Endosperm** | Endosperm | Samenkern-Gewebe. |
| **Endospore** | Endospore | Resistente Spore. |
| **Endosseous** | Endoseal | Knochen-eingebettet. |
| **Endosteal** | Endostal | Inneres Knochen-Futter. |
| **Endosteum** | Endosteum | Knochen-Innenseite. |
| **Endothelial** | Endothel-bezogen | Gefäß-Innen. |
| **Endothelioma** | Endotheliom | Tumor vom Endothel. |
| **Endothelium** | Endothel | Gefäß-Innen-Schicht. |
| **Endotherm** | Endotherm | Warmblüter. |
| **Endothermic** | Endotherm | Wärme-aufnehmend. |
| **Endothermy** | Endothermie | Innere Wärmeerzeugung. |
| **Endotoxin** | Endotoxin | Baklische Giftstoff. |
| **Endotracheal** | Endotracheal | In Luftröhre. |
| **Endotrophic** | Endotroph | Innen-Ernährung. |
| **Endotron** | Endotron | Nicht relevant. |
| **Endotrophic** | Endotrophisch | Innen-Ernährung. |
| **Endozoon** | Entozoon | Inneres Tier (Parasit). |
| **Endozooic** | Entozooisch | Von Entozoon bezogen. |
| **Endozooic Dispersal** | Entozooische Ausbreitung | Nicht relevant. |
| **Endow** | Stiften | Nicht relevant. |
| **Endowment** | Stiftung | Nicht relevant. |
| **Endpaper** | Vorsatzpapier | Nicht relevant. |
| **Endpiece** | Schlußteil | Nicht relevant. |
| **Endplate** | Endplate | Muskel-Struktur. |
| **Endue** | Ausstatten | Nicht relevant. |
| **Endued** | Ausgestattet | Nicht relevant. |
| **Enduing** | Ausstatten | Nicht relevant. |
| **Endurance** | Ausdauer | Durchhaltevermögen. |
| **Endurances** | Ausdauern | Plural. |
| **Endure** | Ertragen | Ertragen, Aushalten. |
| **Endured** | Ertragen | Vergangenheit. |
| **Endures** | Erträgt | Gegenwart. |
| **Enduring** | Dauernd | Anhaltend. |
| **Enduringly** | Anhaltend | Mit Ausdauer. |
| **Enduringness** | Anhaltung | Zustand. |
| **Endways** | Auf eine Ende | Nicht relevant. |
| **Endwise** | Auf eine Ende | Nicht relevant. |
| **Endwork** | Abschlußwerk | Nicht relevant. |
| **Endozoon** | Entozoon | Parasit. |

(Glossar gekürzt auf ~100 Einträge für Raum)
