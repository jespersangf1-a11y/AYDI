...
CLASS_LAYOUT_TEMPLATES = {
    ...
    "racing_sail": {
        "interior_depth_factor": 0.40,
        "deck_height_mm": 1800,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.25},
            {"name": "Salon", "type": "salon", "area_pct": 0.20},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.07},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.12, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.05, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.06},
            {"name": "Motorraum", "type": "engine", "area_pct": 0.05},
            {"name": "Stauraum", "type": "storage", "area_pct": 0.10},
        ],
        "typical_passages": [
            {"from": "Cockpit", "to": "Salon", "type": "primary"},
        ...
        "passage_widths": {"primary": 550, "secondary": 500, "service": 450},
        "default_cabins": 1,
        "default_heads": 1,
    },
    "daysailer": {
        "interior_depth_factor": 0.38,
        "deck_height_mm": 1750,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.30},
            {"name": "Salon", "type": "salon", "area_pct": 0.22},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.08},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.12, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.06, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.05},
            {"name": "Motorraum", "type": "engine", "area_pct": 0.05},
            {"name": "Stauraum", "type": "storage", "area_pct": 0.09},
        ],
        "typical_passages": [
            {"from": "Cockpit", "to": "Salon", "type": "primary"},
            {"from": "Salon", "to": "Pantry", "type": "primary"},
        ...
        "passage_widths": {"primary": 600, "secondary": 550, "service": 500},
        "default_cabins": 1,
        "default_heads": 1,
    },
    "motorsailer": {
        "interior_depth_factor": 0.46,
        "deck_height_mm": 1950,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.18},
            {"name": "Salon", "type": "salon", "area_pct": 0.23},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.09},
            {"name": "Achterkabine", "type": "cabin", "area_pct": 0.11, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.05, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.05},
        ...
        "passage_widths": {"primary": 700, "secondary": 600, "service": 550},
        "default_cabins": 2,
        "default_heads": 1,
    },
    "catamaran_sail": {
        "interior_depth_factor": 0.48,
        "deck_height_mm": 1950,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.18},
            {"name": "Salon", "type": "salon", "area_pct": 0.24},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.09},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.10, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.05, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.05},
    ...
    "catamaran_motor": {
        ...
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.15},
            {"name": "Salon", "type": "salon", "area_pct": 0.21},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.08},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.10, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.04, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.06},
        ...
        "passage_widths": {"primary": 800, "secondary": 700, "service": 600},
        "default_cabins": 2,
        "default_heads": 1,
    },
    "small_motor": {
        "interior_depth_factor": 0.47,
        "deck_height_mm": 1950,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.16},
            {"name": "Salon", "type": "salon", "area_pct": 0.20},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.08},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.10, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.04, "per_head": True},
        ...
        "passage_widths": {"primary": 750, "secondary": 650, "service": 600},
        "default_cabins": 2,
        "default_heads": 1,
    },
    "sport_cruiser": {
        ...
        "deck_height_mm": 2050,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.14},
            {"name": "Salon", "type": "salon", "area_pct": 0.21},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.08},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.10, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.04, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.07},
            {"name": "Maschinenraum", "type": "engine", "area_pct": 0.08},
            {"name": "Stauraum", "type": "storage", "area_pct": 0.08},
            {"name": "Flybridge", "type": "flybridge", "area_pct": 0.12},
            {"name": "Crew", "type": "crew_quarters", "area_pct": 0.04},
        ],
        "typical_passages": [
            {"from": "Cockpit", "to": "Salon", "type": "primary"},
            {"from": "Salon", "to": "Pantry", "type": "primary"},
    ...
    "trawler": {
        "interior_depth_factor": 0.51,
        "deck_height_mm": 2050,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.12},
            {"name": "Salon", "type": "salon", "area_pct": 0.20},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.08},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.10, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.04, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.06},
            {"name": "Maschinenraum", "type": "engine", "area_pct": 0.09},
            {"name": "Stauraum", "type": "storage", "area_pct": 0.10},
            {"name": "Flybridge", "type": "flybridge", "area_pct": 0.11},
            {"name": "Crew", "type": "crew_quarters", "area_pct": 0.05},
        ],
        "typical_passages": [
            {"from": "Cockpit", "to": "Salon", "type": "primary"},
    ...
    "explorer": {
        "interior_depth_factor": 0.52,
        "deck_height_mm": 2100,
        "typical_zones": [
            {"name": "Cockpit", "type": "cockpit", "area_pct": 0.11},
            {"name": "Salon", "type": "salon", "area_pct": 0.19},
            {"name": "Pantry", "type": "pantry", "area_pct": 0.07},
            {"name": "Kabine", "type": "cabin", "area_pct": 0.09, "per_cabin": True},
            {"name": "Nasszelle", "type": "head", "area_pct": 0.03, "per_head": True},
            {"name": "Steuerstand", "type": "helm", "area_pct": 0.06},
            {"name": "Maschinenraum", "type": "engine", "area_pct": 0.09},
            {"name": "Stauraum", "type": "storage", "area_pct": 0.10},
        ...
        "passage_widths": {"primary": 900, "secondary": 750, "service": 650},
        "default_cabins": 3,
        "default_heads": 2,
    },
    "superyacht": {
